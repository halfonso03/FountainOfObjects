...
namespace Level31_FountainOfObjects.GameBoard.Board
{
    ...
    public class GameBoard : IGameBoard
    {
        ...
        public bool PlayerLandedOnObstacle<T>(Position playerPosition) where T : Obstacle
        {
            return _obstacles
        ...
        public Obstacle? GetObstacleAtPosition(Position playerPosition)
        {
            var tt = _obstacles
        ...
        public Obstacle[] GetNearestObstacles(Position playerPosition)
        {
            int obstacleCount = 0;
